...
<body>
		<div class="container" style="margin-top:40px">
            ...
            <div class="form-group">
						...
						<input class="form-control" placeholder="Id number" name="ID" type="text" value="">
						</div>
						</div>
						<br>
                         <div class="form-group">
						...
						<input class="form-control" placeholder="vehicle type" name="Vehicle" type="text" autofocus>
						</div>
						<br>
						<div class="form-group">
