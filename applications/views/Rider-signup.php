  <head>
        ...
        <title>Sign Up Form For riders</title>
...
2
    accept-charset='UTF-8'>
     ...
     <input type="text" id="vehicle" name="Vehicle_type">
          ...
          <label>Age:</label>
          <input type="radio" id="Over_21" value="under_21" name="user_age"><label for="Over_21" class="light">Over 21</label><br>
